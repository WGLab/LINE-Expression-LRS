...
echo "L1 Loci Filter on the $L1_ref_type Reference L1 Regions"


sorted_output_bam=../${sample_name}/d_LINE_quantification/${L1_ref_type}/read_filter/${sample_name}_read_filter_passed.sorted_position.bam
L1_ref_regions=../references/L1Base2_filtered/${L1_ref_type}_filtered.bed
bedgraph_sort_output="../github-testing/${sample_name}/d_LINE_quantification/${L1_ref_type}/read_filter/${sample_name}_bedgraph_sorted.bg"

cd ../${sample_name}/d_LINE_quantification/${L1_ref_type}/

mkdir -p "L1_loci_filter"; cd "L1_loci_filter"
